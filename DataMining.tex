...
\captionof{figure}{CHAID - ohne Merkmalauswahl}
\end{center}

\begin{center}
\includegraphics[width=\textwidth]{Screens/chaid_m}
\captionof{figure}{CHAID - mit Merkmalauswahl}
\end{center}
...
\bibitem[2]{nodes} {\it IBM SPSS Modeler 18.0 Modellierungsknoten} 
