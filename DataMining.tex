...
\bibitem[2]{nodes} {\it IBM SPSS Modeler 18.1 Modeling Nodes} 
\url{ftp://public.dhe.ibm.com/software/analytics/spss/documentation/modeler/18.1.1/en/ModelerModelingNodes.pdf}
\end{thebibliography}
