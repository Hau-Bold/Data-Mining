...
\captionof{figure}{C5.0-Modellierung ohne Merkmalauswahl}
\end{center}

\begin{center}
\includegraphics[width=\textwidth]{Screens/c50_m}
\captionof{figure}{C5.0-Modellierung mit Merkmalauswahl}
\end{center}
...
\captionof{figure}{Random-Trees Modellierung ohne Merkmalauswahl}
\end{center}
...
\captionof{figure}{XGBoost-Baum -Modellierung ohne Merkmalauswahl}
\end{center}

\begin{center}
\includegraphics[width=\textwidth]{Screens/xrandom_m}
\captionof{figure}{XGBoost-Baum -Modellierung mit Merkmalauswahl}
\end{center}
